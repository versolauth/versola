...
CREATE INDEX idx_authorization_presets_tenant_client ON authorization_presets(client_id);
...
BEGIN
    ...
    PERFORM pg_notify('preset_change', json_build_object('id', rec.id, 'op', TG_OP)::text);
    RETURN NULL;
END;
$$ LANGUAGE plpgsql;
